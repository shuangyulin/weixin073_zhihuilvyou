...
import center from '@/views/center'
    ...
    import discussjingquhuodong from '@/views/modules/discussjingquhuodong/list'
    import jingquhuodong from '@/views/modules/jingquhuodong/list'
...
const routes = [{
	...
	path: '/storeup',
      ...
      ,{
	path: '/discussjingquhuodong',
        name: '景区活动评论',
        component: discussjingquhuodong
      }
      ,{
	path: '/jingquhuodong',
        name: '景区活动',
        component: jingquhuodong
      }
      ,{
	path: '/config',
        name: '轮播图管理',
